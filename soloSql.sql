...
UPDATE syntax_practice SET account_balance = 0 WHERE transactions_attempted = 0 AND account_balance = 0;
...
--Insert new record.
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('Drew', 'MINNIAP', 50, 10, 35332345.80);
--The bank is losing money in Miami and Pheonix and needs to unload low transaction customers: Delete users that reside in miami OR phoenix and have completed fewer than 5 transactions.
DELETE FROM syntax_practice WHERE transactions_completed < 5 AND city = 'miami' OR city = 'pheonix';
